...
const MobileNavbar = ({ user, loading }: UserProp) => {
    ...
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side={"left"} className="pr-0 flex flex-col">
          {/*<SheetHeader>
            <SheetTitle className="text-[25px]">Techskills</SheetTitle>
            <SheetDescription>
          ...
          <ScrollArea className="my-4 h-full pb-10 pl-6">
            <div className="flex flex-col space-y-3">
              ...
              <MobileLink href="/blogs" onOpenChange={setOpen}>
                Blogs
              </MobileLink>
              ...
              {loading
                ? user != null && (
                    <>
                      ...
                      <MobileLink href="/blogs/add" onOpenChange={setOpen}>
                        Add Blog
                      </MobileLink>
                    </>
                  )
